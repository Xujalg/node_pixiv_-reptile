...
var options = {
  ...
  agentClass: Agent,
  agentOptions: {
    socksHost: 'tunnel-jp-01.jutasky.cn',
    socksPort: '80',
  ...
  // uri: encodeURI('https://www.pixiv.net/artworks/95304729'),
  headers: headers,
